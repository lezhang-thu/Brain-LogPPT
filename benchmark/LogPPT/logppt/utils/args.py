...
class MainArguments:
    ...
    mode: Optional[str] = field(
        ...
        metadata={
            "help": "Training model. choose from prompt-tuning or fine-tuning",
    ...
    unlabeled_file: Optional[str] = field(
        default=None,
        metadata={
            "help": "A json file containing the unlabeled training data."
        })
    ...
    shot: Optional[int] = field(
        default=50, metadata={"help": "The number of examples use for tuning"})
...
class TrainArguments:
    ...
    no_label_words: Optional[int] = field(
        default=8, metadata={"help": "number of label words"})

    def __post_init__(self):
        if self.lr_scheduler_type not in LR_SCHEDULER_TYPE:
            raise ValueError(
                "Unknown learning rate scheduler, you should pick one in " +
                ",".join(LR_SCHEDULER_TYPE))
...
@dataclass
class TaskArguments:
    task_name: Optional[str] = field(default="log-parsing",
                                     metadata={
                                         "help":
    ...
    dataset_name: Optional[str] = field(
        default="Apache", metadata={"help": "The name of the dataset"})

    log_file: Optional[str] = field(
        default="Apache_2k.log", metadata={"help": "The name of the log file"})

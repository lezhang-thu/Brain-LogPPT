...
def evaluate(groundtruth, parsedresult):
    ...
    (precision, recall, f_measure,
     accuracy_PA) = get_accuracy(df_groundtruth['EventTemplate'],
    ...
    if n_unseen_logs == 0:
        ...
        unseen_PA = accuracy_score(
            np.array(df_unseen_groundtruth.EventTemplate.values, dtype='str'),
    ...
    print(
        ...
        % (precision, recall, f_measure, accuracy_PA,
